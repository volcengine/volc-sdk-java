...
public class BinaryGeometry extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1420643168311649024L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BinaryGeometry\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"bytes\"}]}");
   ...
   */
  public static org.example.avro.BinaryGeometry.Builder newBuilder() {
    return new org.example.avro.BinaryGeometry.Builder();
  }
   ...
   * @return A new BinaryGeometry RecordBuilder
   */
  public static org.example.avro.BinaryGeometry.Builder newBuilder(org.example.avro.BinaryGeometry.Builder other) {
    return new org.example.avro.BinaryGeometry.Builder(other);
  }
   ...
   * @return A new BinaryGeometry RecordBuilder
   */
  public static org.example.avro.BinaryGeometry.Builder newBuilder(org.example.avro.BinaryGeometry other) {
    return new org.example.avro.BinaryGeometry.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BinaryGeometry>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.BinaryGeometry.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.BinaryGeometry other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.BinaryGeometry.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.BinaryGeometry.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.BinaryGeometry.Builder setValue(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.BinaryGeometry.Builder clearValue() {
      value = null;
