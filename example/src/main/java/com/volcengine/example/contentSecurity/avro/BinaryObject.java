...
public class BinaryObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2126406612664795038L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BinaryObject\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"bytes\"}]}");
   ...
   */
  public static org.example.avro.BinaryObject.Builder newBuilder() {
    return new org.example.avro.BinaryObject.Builder();
  }
   ...
   * @return A new BinaryObject RecordBuilder
   */
  public static org.example.avro.BinaryObject.Builder newBuilder(org.example.avro.BinaryObject.Builder other) {
    return new org.example.avro.BinaryObject.Builder(other);
  }
   ...
   * @return A new BinaryObject RecordBuilder
   */
  public static org.example.avro.BinaryObject.Builder newBuilder(org.example.avro.BinaryObject other) {
    return new org.example.avro.BinaryObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BinaryObject>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.BinaryObject.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.BinaryObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.BinaryObject.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.BinaryObject.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.BinaryObject.Builder setValue(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.BinaryObject.Builder clearValue() {
      value = null;
