...
public class Decimal extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8060471348519092220L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Decimal\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"value\",\"type\":\"string\"},{\"name\":\"precision\",\"type\":\"int\"},{\"name\":\"scale\",\"type\":\"int\"}]}");
   ...
   */
  public static org.example.avro.Decimal.Builder newBuilder() {
    return new org.example.avro.Decimal.Builder();
  }
   ...
   * @return A new Decimal RecordBuilder
   */
  public static org.example.avro.Decimal.Builder newBuilder(org.example.avro.Decimal.Builder other) {
    return new org.example.avro.Decimal.Builder(other);
  }
   ...
   * @return A new Decimal RecordBuilder
   */
  public static org.example.avro.Decimal.Builder newBuilder(org.example.avro.Decimal other) {
    return new org.example.avro.Decimal.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Decimal>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.Decimal.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.Decimal other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Decimal.Builder setValue(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Decimal.Builder clearValue() {
      value = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Decimal.Builder setPrecision(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Decimal.Builder clearPrecision() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Decimal.Builder setScale(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Decimal.Builder clearScale() {
