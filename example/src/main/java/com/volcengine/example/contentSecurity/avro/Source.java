...
public class Source extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5027818373528239856L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Source\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"sourceType\",\"type\":{\"type\":\"enum\",\"name\":\"SourceType\",\"symbols\":[\"MySQL\",\"Oracle\",\"SQLServer\",\"PostgreSQL\",\"MongoDB\",\"Redis\",\"DB2\",\"PPAS\",\"DRDS\",\"HBASE\",\"HDFS\",\"FILE\",\"OTHER\"]}},{\"name\":\"version\",\"type\":\"string\",\"doc\":\"source datasource version information\"}]}");
  ...
  @Deprecated public org.example.avro.SourceType sourceType;
   ...
   */
  public Source(org.example.avro.SourceType sourceType, java.lang.CharSequence version) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: sourceType = (org.example.avro.SourceType)value$; break;
   ...
   */
  public org.example.avro.SourceType getSourceType() {
    return sourceType;
  }
   ...
   */
  public void setSourceType(org.example.avro.SourceType value) {
   ...
   */
  public static org.example.avro.Source.Builder newBuilder() {
    return new org.example.avro.Source.Builder();
  }
   ...
   * @return A new Source RecordBuilder
   */
  public static org.example.avro.Source.Builder newBuilder(org.example.avro.Source.Builder other) {
    return new org.example.avro.Source.Builder(other);
  }
   ...
   * @return A new Source RecordBuilder
   */
  public static org.example.avro.Source.Builder newBuilder(org.example.avro.Source other) {
    return new org.example.avro.Source.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Source>
    ...
    private org.example.avro.SourceType sourceType;
    /** source datasource version information */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.Source.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.Source other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.sourceType)) {
        this.sourceType = data().deepCopy(fields()[0].schema(), other.sourceType);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Source.Builder setSourceType(org.example.avro.SourceType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Source.Builder clearSourceType() {
      sourceType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Source.Builder setVersion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Source.Builder clearVersion() {
      version = null;
    ...
    public Source build() {
      try {
        ...
        record.sourceType = fieldSetFlags()[0] ? this.sourceType : (org.example.avro.SourceType) defaultValue(fields()[0]);
