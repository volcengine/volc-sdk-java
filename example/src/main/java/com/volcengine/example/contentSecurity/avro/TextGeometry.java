...
public class TextGeometry extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7530819297214307581L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TextGeometry\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"string\"}]}");
   ...
   */
  public static org.example.avro.TextGeometry.Builder newBuilder() {
    return new org.example.avro.TextGeometry.Builder();
  }
   ...
   * @return A new TextGeometry RecordBuilder
   */
  public static org.example.avro.TextGeometry.Builder newBuilder(org.example.avro.TextGeometry.Builder other) {
    return new org.example.avro.TextGeometry.Builder(other);
  }
   ...
   * @return A new TextGeometry RecordBuilder
   */
  public static org.example.avro.TextGeometry.Builder newBuilder(org.example.avro.TextGeometry other) {
    return new org.example.avro.TextGeometry.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TextGeometry>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.TextGeometry.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.TextGeometry other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.TextGeometry.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.TextGeometry.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.TextGeometry.Builder setValue(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.TextGeometry.Builder clearValue() {
      value = null;
