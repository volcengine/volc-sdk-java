...
public class Timestamp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 312606598289071325L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Timestamp\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"millis\",\"type\":\"int\"}]}");
   ...
   */
  public static org.example.avro.Timestamp.Builder newBuilder() {
    return new org.example.avro.Timestamp.Builder();
  }
   ...
   * @return A new Timestamp RecordBuilder
   */
  public static org.example.avro.Timestamp.Builder newBuilder(org.example.avro.Timestamp.Builder other) {
    return new org.example.avro.Timestamp.Builder(other);
  }
   ...
   * @return A new Timestamp RecordBuilder
   */
  public static org.example.avro.Timestamp.Builder newBuilder(org.example.avro.Timestamp other) {
    return new org.example.avro.Timestamp.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Timestamp>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.Timestamp.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.Timestamp other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.timestamp)) {
        this.timestamp = data().deepCopy(fields()[0].schema(), other.timestamp);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Timestamp.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Timestamp.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Timestamp.Builder setMillis(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Timestamp.Builder clearMillis() {
