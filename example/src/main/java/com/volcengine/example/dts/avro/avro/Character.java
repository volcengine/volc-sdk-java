...
public class Character extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8869008193206296332L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Character\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"charset\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"bytes\"}]}");
   ...
   */
  public static org.example.avro.Character.Builder newBuilder() {
    return new org.example.avro.Character.Builder();
  }
   ...
   * @return A new Character RecordBuilder
   */
  public static org.example.avro.Character.Builder newBuilder(org.example.avro.Character.Builder other) {
    return new org.example.avro.Character.Builder(other);
  }
   ...
   * @return A new Character RecordBuilder
   */
  public static org.example.avro.Character.Builder newBuilder(org.example.avro.Character other) {
    return new org.example.avro.Character.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Character>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.Character.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.Character other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.charset)) {
        this.charset = data().deepCopy(fields()[0].schema(), other.charset);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Character.Builder setCharset(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Character.Builder clearCharset() {
      charset = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Character.Builder setValue(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Character.Builder clearValue() {
      value = null;
