...
public class Field extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7135672767727862679L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Field\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"dataTypeNumber\",\"type\":\"int\"}]}");
   ...
   */
  public static org.example.avro.Field.Builder newBuilder() {
    return new org.example.avro.Field.Builder();
  }
   ...
   * @return A new Field RecordBuilder
   */
  public static org.example.avro.Field.Builder newBuilder(org.example.avro.Field.Builder other) {
    return new org.example.avro.Field.Builder(other);
  }
   ...
   * @return A new Field RecordBuilder
   */
  public static org.example.avro.Field.Builder newBuilder(org.example.avro.Field other) {
    return new org.example.avro.Field.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Field>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.Field.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.Field other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Field.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Field.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Field.Builder setDataTypeNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.Field.Builder clearDataTypeNumber() {
