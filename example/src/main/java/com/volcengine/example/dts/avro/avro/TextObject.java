...
public class TextObject extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4271455369194461481L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TextObject\",\"namespace\":\"org.example.avro\",\"fields\":[{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"string\"}]}");
   ...
   */
  public static org.example.avro.TextObject.Builder newBuilder() {
    return new org.example.avro.TextObject.Builder();
  }
   ...
   * @return A new TextObject RecordBuilder
   */
  public static org.example.avro.TextObject.Builder newBuilder(org.example.avro.TextObject.Builder other) {
    return new org.example.avro.TextObject.Builder(other);
  }
   ...
   * @return A new TextObject RecordBuilder
   */
  public static org.example.avro.TextObject.Builder newBuilder(org.example.avro.TextObject other) {
    return new org.example.avro.TextObject.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TextObject>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.example.avro.TextObject.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.example.avro.TextObject other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.TextObject.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.TextObject.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.TextObject.Builder setValue(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.example.avro.TextObject.Builder clearValue() {
      value = null;
