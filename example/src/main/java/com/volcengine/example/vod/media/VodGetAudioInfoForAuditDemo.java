...
public class VodGetAudioInfoForAuditDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            com.volcengine.service.vod.model.request.VodGetAudioInfoForAuditRequest.Builder reqBuilder = com.volcengine.service.vod.model.request.VodGetAudioInfoForAuditRequest.newBuilder();
			reqBuilder.setVid("your Vid");
			reqBuilder.setStrategy("your Strategy");
			
            com.volcengine.service.vod.model.response.VodGetAudioInfoForAuditResponse resp = vodService.getAudioInfoForAudit(reqBuilder.build());
