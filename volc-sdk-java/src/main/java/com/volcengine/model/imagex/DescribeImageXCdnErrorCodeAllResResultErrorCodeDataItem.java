...
/**
 * DescribeImageXCdnErrorCodeAllResResultErrorCodeDataItem
 */
@lombok.Data
public final class DescribeImageXCdnErrorCodeAllResResultErrorCodeDataItem  {
     ...
     *
     * <p>* 取值`Country`时，表示国家；</p>
     *
     * <p>* 取值`Province`时，表示省份。</p>
     */
    ...
    private List<DescribeImageXCdnErrorCodeAllResResultErrorCodeDataItemDetailsItem> details;
