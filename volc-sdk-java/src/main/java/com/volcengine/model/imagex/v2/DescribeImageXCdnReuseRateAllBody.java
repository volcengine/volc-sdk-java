 ...
 */
@lombok.Data
public final class DescribeImageXCdnReuseRateAllBody  {
    ...
    private List<DescribeImageXCdnReuseRateAllBodyExtraDimsItem> extraDims;
    ...
    /**
     * <p>维度区分，不传或者传空默认按上报量排序。取值如下所示：</p>
     *
     * <p>* `ReuseRate`：按连接复用率排序；</p>
     *
     * <p>* `Count`：按上报量排序。</p>
     */
