 ...
 */
@lombok.Data
public final class DescribeImageXClientScoreByTimeBody  {
    ...
    private List<DescribeImageXClientScoreByTimeBodyExtraDimsItem> extraDims;
     ...
     * <p>- `vmaf`：查询 vmaf 指标</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "ScoreType")
