 ...
 */
@lombok.Data
public final class DescribeImageXHeifEncodeSuccessCountByTimeBody  {
    ...
    private List<DescribeImageXHeifEncodeSuccessCountByTimeBodyExtraDimsItem> extraDims;
     ...
     *
     * <p>- 公共维度：`AppVer`、`SdkVer`、`ImageType`、`ImageResolution`</p>
     *
