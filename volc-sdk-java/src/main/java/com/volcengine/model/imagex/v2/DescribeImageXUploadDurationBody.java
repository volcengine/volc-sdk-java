 ...
 */
@lombok.Data
public final class DescribeImageXUploadDurationBody  {
    ...
    private List<DescribeImageXUploadDurationBodyExtraDimsItem> extraDims;

    /**
     * <p>拆分维度。默认为空，获取拆分分位数据。支持取值：</p>
     *
     * <p>* `Duration`：表示为分位数据</p>
     *
     * <p>- `Phase`：表示分阶段数据，仅当`UploadType`取值为`2`时支持取值。</p>
     *
    ...
    /**
     * <p>上传类型，默认为空，返回上传 1.0 数据。取值如下所示：</p>
     *
     * <p>* `1`：上传 1.0。</p>
     *
     * <p>* `2`：上传 2.0。</p>
