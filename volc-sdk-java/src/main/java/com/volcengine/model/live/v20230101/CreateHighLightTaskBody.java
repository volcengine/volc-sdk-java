...
public final class CreateHighLightTaskBody  {
     ...
     * <p>- `0`：体育足球。</p>
     *
     * <p>- `1`：文娱短剧，适用于视频源类型为点播视频的场景，即 `"Type":1`。</p>
     *
     * <p>- `2`：电商，支持视频源类型为点播视频的场景，即 `"Type":1`。其他场景的支持情况，请关注文档更新。</p>
     */
     ...
     *
     * <p>- 体育足球：`0` 表示默认类型剪辑，主要适用于含解说赛事的高光提取。</p>
     *
     * <p>- 文娱短剧：`0` 表示默认类型剪辑。</p>
     *
     * <p>- 电商：`0` 表示默认类型剪辑，主要适用于即时零售场景的高光提取；`1` 表示按转场分镜剪辑，主要适用于按转场切分视频以获取原始素材的场景。默认值为 `0`。</p>
     */
