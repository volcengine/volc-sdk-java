...
/**
 * CreateSpeechTaskBodyRuleSubtitleTranslationItem
 */
@lombok.Data
public final class CreateSpeechTaskBodyRuleSubtitleTranslationItem  {
    ...
    private CreateSpeechTaskBodyRuleSubtitleTranslationItemBox box;

    /**
     * <p>字体阴影。</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "Border")
    private CreateSpeechTaskBodyRuleSubtitleTranslationItemBorder border;
