...
/**
 * CreateSubtitleTranscodePresetBodySIConfig
 */
@lombok.Data
public final class CreateSubtitleTranscodePresetBodySIConfig  {

    /**
     * <p>是否开启声影同传模式。默认值为 `false`。取值如下：</p>
     *
