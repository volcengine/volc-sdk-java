 ...
 */
@lombok.Data
public final class TranscodingJobStatusQuery  {
    ...
    /**
     * <p>推流域名。您可以调用 [ListDomainDetail](https://www.volcengine.com/docs/6469/1126815) 接口或在视频直播控制台的[域名管理](https://console.volcengine.com/live/main/domain/list)页面，查看需要查询的推流域名。</p>
     *
     * <p>:::tip</p>
     *
     * <p>Vhost 和 PushDomain 二选一必填。</p>
