...
@Data
@NoArgsConstructor
public class ModifyAlarmContentTemplateRequest {
    ...
    public boolean CheckValidation() {
        if (this.alarmContentTemplateId == null || this.alarmContentTemplateId.isEmpty() || this.alarmContentTemplateName == null || this.alarmContentTemplateName.isEmpty()) {
            return false;
        }
        return true;
    }
