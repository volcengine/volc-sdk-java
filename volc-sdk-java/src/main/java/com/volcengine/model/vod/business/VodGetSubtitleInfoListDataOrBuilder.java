...
public interface VodGetSubtitleInfoListDataOrBuilder extends
    // @@protoc_insertion_point(interface_extends:Volcengine.Models.Vod.Business.VodGetSubtitleInfoListData)
   ...
   */
  java.util.List<com.volcengine.model.vod.business.VodFileSubtitleInfo> 
   ...
   * <code>repeated .Volcengine.Models.Vod.Business.VodFileSubtitleInfo FileSubtitleInfoList = 2;</code>
   */
  com.volcengine.model.vod.business.VodFileSubtitleInfo getFileSubtitleInfoList(int index);
  /**
   * <pre>
   *字幕列表
   * </pre>
   ...
   * <code>repeated .Volcengine.Models.Vod.Business.VodFileSubtitleInfo FileSubtitleInfoList = 2;</code>
   */
  java.util.List<? extends com.volcengine.model.vod.business.VodFileSubtitleInfoOrBuilder> 
   ...
   * <code>repeated .Volcengine.Models.Vod.Business.VodFileSubtitleInfo FileSubtitleInfoList = 2;</code>
   */
  com.volcengine.model.vod.business.VodFileSubtitleInfoOrBuilder getFileSubtitleInfoListOrBuilder(
      int index);
