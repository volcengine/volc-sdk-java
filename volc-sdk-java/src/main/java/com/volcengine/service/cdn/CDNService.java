...
public interface CDNService extends IBaseService {
    ...
    CDN.EmptyResponse addCdnDomain(CDN.AddCdnDomainRequest request) throws Exception;

    // 上线加速域名: https://www.volcengine.com/docs/6454/74667
    CDN.EmptyResponse startCdnDomain(CDN.StartCdnDomainRequest request) throws Exception;

    // 下线加速域名: https://www.volcengine.com/docs/6454/75129
    CDN.EmptyResponse stopCdnDomain(CDN.StopCdnDomainRequest request) throws Exception;

    // 删除加速域名: https://www.volcengine.com/docs/6454/75130
    CDN.EmptyResponse deleteCdnDomain(CDN.DeleteCdnDomainRequest request) throws Exception;
    ...
    CDN.EmptyResponse updateCdnConfig(CDN.UpdateCdnConfigRequest request) throws Exception;
    ...
    CDN.EmptyResponse addResourceTags(CDN.AddResourceTagsRequest request) throws Exception;

    // 更新资源标签: https://www.volcengine.com/docs/6454/80313
    CDN.EmptyResponse updateResourceTags(CDN.UpdateResourceTagsRequest request) throws Exception;
    ...
    CDN.EmptyResponse deleteResourceTags(CDN.DeleteResourceTagsRequest request) throws Exception;
}
