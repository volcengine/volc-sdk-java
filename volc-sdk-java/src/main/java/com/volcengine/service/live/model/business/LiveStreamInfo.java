...
/**
 * Protobuf type {@code Volcengine.Live.Models.Business.LiveStreamInfo}
 */
public final class LiveStreamInfo extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:Volcengine.Live.Models.Business.LiveStreamInfo)
    LiveStreamInfoOrBuilder {
private static final long serialVersionUID = 0L;
  // Use LiveStreamInfo.newBuilder() to construct.
  private LiveStreamInfo(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              streamInfoList_ = new java.util.ArrayList<StreamInfoList>();
              mutable_bitField0_ |= 0x00000001;
            }
            streamInfoList_.add(
                input.readMessage(StreamInfoList.parser(), extensionRegistry));
            break;
          }
          case 16: {
  ...
  protected FieldAccessorTable
    ...
    return StreamManage.internal_static_Volcengine_Live_Models_Business_LiveStreamInfo_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            LiveStreamInfo.class, Builder.class);
  }

  public static final int STREAMINFOLIST_FIELD_NUMBER = 1;
  private java.util.List<StreamInfoList> streamInfoList_;
  /**
   * <pre>
   * 流信息列表
   * </pre>
   ...
   */
  @Override
  public java.util.List<StreamInfoList> getStreamInfoListList() {
   ...
   */
  @Override
  public java.util.List<? extends StreamInfoListOrBuilder>
   ...
   */
  @Override
  public StreamInfoList getStreamInfoList(int index) {
   ...
   */
  @Override
  public StreamInfoListOrBuilder getStreamInfoListOrBuilder(
      int index) {
    return streamInfoList_.get(index);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    LiveStreamInfo other = (LiveStreamInfo) obj;
  ...
  public static LiveStreamInfo parseFrom(
  ...
  public static LiveStreamInfo parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static LiveStreamInfo parseFrom(
  ...
  public static LiveStreamInfo parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static LiveStreamInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static LiveStreamInfo parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(LiveStreamInfo prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:Volcengine.Live.Models.Business.LiveStreamInfo)
      LiveStreamInfoOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return StreamManage.internal_static_Volcengine_Live_Models_Business_LiveStreamInfo_descriptor;
    ...
    // Construct using com.volcengine.service.live.model.business.LiveStreamInfo.newBuilder()
    private Builder() {
    ...
    public LiveStreamInfo build() {
      LiveStreamInfo result = buildPartial();
    ...
    public LiveStreamInfo buildPartial() {
      LiveStreamInfo result = new LiveStreamInfo(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof LiveStreamInfo) {
        return mergeFrom((LiveStreamInfo)other);
      } else {
    ...
    public Builder mergeFrom(LiveStreamInfo other) {
      if (other == LiveStreamInfo.getDefaultInstance()) return this;
      if (streamInfoListBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      LiveStreamInfo parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (LiveStreamInfo) e.getUnfinishedMessage();
    ...
    private void ensureStreamInfoListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        streamInfoList_ = new java.util.ArrayList<StreamInfoList>(streamInfoList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        StreamInfoList, StreamInfoList.Builder, StreamInfoListOrBuilder> streamInfoListBuilder_;
    ...
    public Builder setStreamInfoList(
        int index, StreamInfoList value) {
      if (streamInfoListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setStreamInfoList(
        int index, StreamInfoList.Builder builderForValue) {
      if (streamInfoListBuilder_ == null) {
        ensureStreamInfoListIsMutable();
     ...
     * <code>repeated .Volcengine.Live.Models.Business.StreamInfoList StreamInfoList = 1;</code>
     */
    public Builder addStreamInfoList(StreamInfoList value) {
      if (streamInfoListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllStreamInfoList(
        Iterable<? extends StreamInfoList> values) {
      if (streamInfoListBuilder_ == null) {
        ensureStreamInfoListIsMutable();
     ...
     * <code>repeated .Volcengine.Live.Models.Business.StreamInfoList StreamInfoList = 1;</code>
     */
    public StreamInfoList.Builder getStreamInfoListBuilder(
        int index) {
    ...
    public StreamInfoList.Builder addStreamInfoListBuilder(
        int index) {
      return getStreamInfoListFieldBuilder().addBuilder(
          index, StreamInfoList.getDefaultInstance());
    }
    /**
     * <pre>
     * 流信息列表
     ...
     * <code>repeated .Volcengine.Live.Models.Business.StreamInfoList StreamInfoList = 1;</code>
     */
    public java.util.List<StreamInfoList.Builder>
         getStreamInfoListBuilderList() {
      return getStreamInfoListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        StreamInfoList, StreamInfoList.Builder, StreamInfoListOrBuilder>
        getStreamInfoListFieldBuilder() {
      if (streamInfoListBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:Volcengine.Live.Models.Business.LiveStreamInfo)
  }
  ...
  static {
    DEFAULT_INSTANCE = new LiveStreamInfo();
  }
  ...
  private static final com.google.protobuf.Parser<LiveStreamInfo>
      PARSER = new com.google.protobuf.AbstractParser<LiveStreamInfo>() {
    @Override
    public LiveStreamInfo parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new LiveStreamInfo(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<LiveStreamInfo> parser() {
    return PARSER;
  }

  @Override
  public com.google.protobuf.Parser<LiveStreamInfo> getParserForType() {
    return PARSER;
  }
