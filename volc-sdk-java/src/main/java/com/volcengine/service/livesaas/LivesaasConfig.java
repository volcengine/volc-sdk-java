...
public class LivesaasConfig {
    ...
    public static Map<String, ApiInfo> apiInfoList = new HashMap<String, ApiInfo>() {
        {
            put(Const.DrawActivityRedPacket, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            ...
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DrawActivityRedPacket));
            ...
            put(Const.SendActivityRedPacket, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.SendActivityRedPacket));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListUserChatAPI, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListUserChatAPI));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.CreateVideoRoom, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.CreateVideoRoom));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.DeleteVideoRoom, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DeleteVideoRoom));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListVideoRooms, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListVideoRooms));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetVideoRoomBasicInfo, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetVideoRoomBasicInfo));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.UpdateVideoRoomBasicInfo, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.UpdateVideoRoomBasicInfo));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.AddVideoRoomMedias, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.AddVideoRoomMedias));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.DeleteVideoRoomMedias, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DeleteVideoRoomMedias));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ReorderVideoRoomMedias, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ReorderVideoRoomMedias));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListVideoRoomMedias, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListVideoRoomMedias));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetActivityThumbUpNumber, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetActivityThumbUpNumber));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListPlayUrlsAPI, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListPlayUrlsAPI));
                                    add(new BasicNameValuePair("Version", "2020-06-01"));
                                }
                            });
                        }
            ...
            put(Const.GetActivityLoginSecret, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetActivityLoginSecret));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetActivityCommentReviewExemption, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetActivityCommentReviewExemption));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.AddActivityCommentReviewExemption, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.AddActivityCommentReviewExemption));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.DelActivityCommentReviewExemption, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DelActivityCommentReviewExemption));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.UpdateWebSDKDomain, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.UpdateWebSDKDomain));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListWxMiniAppFiles, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListWxMiniAppFiles));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.AddWxMiniAppFile, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.AddWxMiniAppFile));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.DeleteWxMiniAppFile, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DeleteWxMiniAppFile));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.UpdateAwardConfig, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.UpdateAwardConfig));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.SendAward, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.SendAward));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.WithdrawAward, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.WithdrawAward));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.UpdateCheckInConfig, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.UpdateCheckInConfig));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.DeleteCheckIn, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DeleteCheckIn));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.StopCheckIn, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.StopCheckIn));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.SendCheckIn, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.SendCheckIn));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.WithdrawCheckIn, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.WithdrawCheckIn));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ResumeLiveChannel, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ResumeLiveChannel));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ForbidLiveChannel, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ForbidLiveChannel));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.CreateActivityBonusTask, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.CreateActivityBonusTask));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.UpdateActivityBonusTask, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.UpdateActivityBonusTask));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetActivityBonusTask, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetActivityBonusTask));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListActivityBonusTasks, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListActivityBonusTasks));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.DeleteActivityBonusTask, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DeleteActivityBonusTask));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ChangeActivityBonusTaskStatus, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ChangeActivityBonusTaskStatus));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListActivityBonusTaskWinners, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListActivityBonusTaskWinners));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListVideoScenarios, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListVideoScenarios));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetVideoScenario, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetVideoScenario));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
            ...
            put(Const.CreateVideoTask, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.CreateVideoTask));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                            put(Const.SOCKET_TIMEOUT, 20000);
            ...
            put(Const.EndVideoTask, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.EndVideoTask));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListVideoTasks, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListVideoTasks));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetVideoTask, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetVideoTask));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetVideoReport, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetVideoReport));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
            ...
            put(Const.SubmitVideoAudit, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.SubmitVideoAudit));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListLiveScreenshot, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
            ...
            put(Const.CreateImageTask, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.CreateImageTask));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetImageTask, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetImageTask));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetImageReport, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetImageReport));
                                    add(new BasicNameValuePair("Version", "2024-08-01"));
                                }
                            });
                        }
                    ...
                    new HashMap<String, Object>() {
                        {
                            ...
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.CreateActivityQuestionnaire));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.UpdateActivityQuestionnaire, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.UpdateActivityQuestionnaire));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.DeleteActivityQuestionnaire, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DeleteActivityQuestionnaire));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetActivityQuestionnaire, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetActivityQuestionnaire));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListActivityQuestionnaire, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListActivityQuestionnaire));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.CopyActivityQuestionnaire, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.CopyActivityQuestionnaire));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.PublishActivityQuestionnaire, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.PublishActivityQuestionnaire));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.OfflineActivityQuestionnaire, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
            ...
            put(Const.UpdateActivityLiveAnalysisConfig, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.UpdateActivityLiveAnalysisConfig));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetActivityLiveAnalysisConfig, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetActivityLiveAnalysisConfig));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetLiveAnalysisReportOverview, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetLiveAnalysisReportOverview));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListActivityLiveAnalysisHistories, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListActivityLiveAnalysisHistories));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.ListActivityContentAnalysis, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.ListActivityContentAnalysis));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.UpdateActivityAutoReplyCommentConfig, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "POST");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.UpdateActivityAutoReplyCommentConfig));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
            ...
            put(Const.GetActivityAutoReplyCommentConfig, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(Const.Method, "GET");
                            put(Const.Path, "/");
                            put(Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetActivityAutoReplyCommentConfig));
                                    add(new BasicNameValuePair("Version", "2023-08-01"));
                                }
                            });
                        }
