...
public class Const {
    ...
    public static final String RestoreColdArchiveVideo = "RestoreColdArchiveVideo";
    public static final String GetRestoreVideoStatus = "GetRestoreVideoStatus";
    ...
    public static final String DescribeCdnEdgeIp = "DescribeCdnEdgeIp";
    public static final String DescribeCdnRegionAndIsp = "DescribeCdnRegionAndIsp";
