    ...
    public static Map<String, ApiInfo> apiInfoList = new HashMap<String, ApiInfo>() {
        {
            ...
            // 媒资
            // **********************************************************************
            put(Const.GetMediaEntityList, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "GET");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetMediaEntityList));
                                    add(new BasicNameValuePair("Version", "2023-07-01"));
                                }
                            });
                        }
            ...
            put(Const.GetMediaEntity, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "GET");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetMediaEntity));
                                    add(new BasicNameValuePair("Version", "2023-07-01"));
                                }
                            });
                        }
            ...
            put(Const.DeleteMediaEntity, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "POST");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DeleteMediaEntity));
                                    add(new BasicNameValuePair("Version", "2023-07-01"));
                                }
                            });
                        }
            ...
            put(Const.RestoreColdArchiveVideo, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "GET");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.RestoreColdArchiveVideo));
                                    add(new BasicNameValuePair("Version", "2023-07-01"));
                                }
                            });
                        }
            ...
            put(Const.GetRestoreVideoStatus, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "GET");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.GetRestoreVideoStatus));
                                    add(new BasicNameValuePair("Version", "2023-07-01"));
                                }
                            });
                        }
            ...
            put(Const.SubmitDirectEditTaskSync, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "POST");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.SubmitDirectEditTaskSync));
                                    add(new BasicNameValuePair("Version", "2018-01-01"));
                                }
                            });
                        }
            ...
            put(Const.VerifyDomainOwner, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "POST");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.VerifyDomainOwner));
                                    add(new BasicNameValuePair("Version", "2023-07-01"));
            ...
            put(Const.DescribeDomainVerifyContent, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "GET");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DescribeDomainVerifyContent));
                                    add(new BasicNameValuePair("Version", "2023-07-01"));
            ...
            put(Const.DescribeCdnEdgeIp, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "POST");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DescribeCdnEdgeIp));
                                    add(new BasicNameValuePair("Version", "2023-07-01"));
            ...
            put(Const.DescribeCdnRegionAndIsp, new ApiInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.volcengine.helper.Const.Method, "POST");
                            put(com.volcengine.helper.Const.Path, "/");
                            put(com.volcengine.helper.Const.Query, new ArrayList<NameValuePair>() {
                                {
                                    add(new BasicNameValuePair("Action", Const.DescribeCdnRegionAndIsp));
                                    add(new BasicNameValuePair("Version", "2023-07-01"));
